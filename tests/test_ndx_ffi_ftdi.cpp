...
struct ValidFtdiFixture : FtdiBackendFixture {
...
TEST_CASE_METHOD(ValidFtdiFixture, "createFtdiBackend autoincrements id") {
    auto json2 = createAndParse("{\"serial_number\":\"ABCD1234\"}");
...
TEST_CASE_METHOD(FtdiBackendFixture, "createFtdiBackend returns error if serial number is not size 8") {
